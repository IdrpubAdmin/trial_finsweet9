          ...
          <svg width="122" height="25" viewBox="0 0 122 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1551_633)">
              ...
              <path
                  ...
                  fill="white"/>
              <path d="M12.7715 3.04199H24.709V6.33908H16.9874V11.2577H23.1029V14.4312H16.9797V21.6354H12.7715V3.04199Z"
                    fill="white"/>
              <path
...
module.exports = {
  computed: {
    ...
    navActive() {
      return this.$store.getters["HeaderData"].navActive;
    },
    inactivate() {
      return this.$store.getters["HeaderData"].scrollY >= 150 && this.$store.getters["HeaderData"].lastScrollY < this.$store.getters["HeaderData"].scrollY
    }

  },
  methods: {
    navChange() {
      this.$store.commit('HeaderData/navChange');
    },
    handleScroll() {
