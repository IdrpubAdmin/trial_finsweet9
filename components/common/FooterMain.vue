      ...
      <div class="ft-contact">
        <div class="contact-info">
          ...
          <div class="info-sns">
            ...
            <div class="txt">We are always open to discuss your project, improve your online presence and help with your UX/UI design challenges.</div>
            <div class="sns-list-wrap">
              <ul class="sns-list">
                <li v-for="item in snsData">
